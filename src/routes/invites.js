...
const INVITES = {
  'dna-studio': {
    ...
    sfNote: 'Estamos basados en San Francisco, California, con raíces en la comunidad de eventos creativos.',
  ...
  'dna-studio-en': {
    ...
    sfNote: 'We’re based in San Francisco, California, with roots in the creative events community.',
