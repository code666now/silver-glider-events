...
- **Database:** auto-migrations run on startup from `src/db/migrations/*.sql`. Tables: organizers, magic_link_tokens, events, rsvps, message_log, line_submissions, feedback_submissions, host_invitations.
